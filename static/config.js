...
function getApiUrl(endpoint) {
    if (STATIC_MODE) {
        ...
        const endpointMap = {
            ...
            'api/recommendations': `${BASE_PATH}static/data/recommendations.json`,
            'api/about': `${BASE_PATH}static/data/about.json`
        };
...
const STATIC_DATA_MAP = {
    ...
    'api/recommendations': '/static/data/recommendations.json',
    'api/about': '/static/data/about.json'
};
